...
const fetchSampleResponseSchema = z.object({
  ...
  epsilon_25: z.coerce.number().nullable(),
  epsilon_50: z.coerce.number().nullable(),
  epsilon_max: z.coerce.number().nullable(),
  epsilon_u: z.coerce.number().nullable(),
  sigma_25: z.coerce.number().nullable(),
  sigma_50: z.coerce.number().nullable(),
  sigma_max: z.coerce.number().nullable(),
  sigma_u: z.coerce.number().nullable(),
  createdAt: z.date(),
